...
<header id="header">
    <div class="content">
        ...
        <ul class="actions">
            <li><a href="https://www.youtube.com/watch?v=Z54dVXdGLqk" class="button icon solid fa-chevron-down scrolly videoBtn">Voir la vidéo</a></li>
            <li><a href="#two" class="button icon solid fa-chevron-down scrolly">En savoir plus</a></li>
        </ul>
    </div>
    <iframe width="560" height="315" src="https://www.youtube.com/embed/Z54dVXdGLqk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</header>
