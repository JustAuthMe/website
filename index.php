...
<html lang="fr">
    ...
    <body class="is-preload">
        ...
        <div class="my-cookies" id="cookies_prompt">
            <aside class="actions">
                <button onclick="setCookiesChoice(true)">Accepter</button>
                <button onclick="setCookiesChoice(false)">Refuser</button>
            </aside>
            <p>
        ...
        <header id="header">
            <div class="content">
                ...
                <iframe class="mobile-video" width="560" height="315" src="https://www.youtube-nocookie.com/embed/Z54dVXdGLqk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                <ul class="actions">
                    <li><a href="#two" class="button icon solid fa-chevron-down scrolly">En savoir plus</a></li>
                </ul>
            </div>
            <iframe class="desktop-video" style="margin-top:-50px" width="560" height="315" src="https://www.youtube-nocookie.com/embed/Z54dVXdGLqk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </header>
        ...
        <section id="two" class="wrapper">
            <div class="inner alt">
                ...
                <section class="spotlight">
                    ...
                    <div class="content">
                        <h3>Plus de sécurité, aucun mot de passe</h3>
                        <p>
                ...
                <section class="spotlight">
                    ...
                    <div class="content">
                        ...
                        <p>
                            ...
                            que vous soyez un utilisateur d'iOS ou d'Android, de Windows, macOS ou Linux, JustAuth.Me
        ...
        <section id="three" class="wrapper style2 special">
            ...
            <form method="post" action="" onsubmit="submitForm(1);return false">
                <ul class="actions special">
                    <li><input class="email my-input" type="email" placeholder="Adresse E-Mail" name="email" required /></li>
        ...
        <script type="text/javascript">
            const user_lang = '<?= substr($_SERVER['HTTP_ACCEPT_LANGUAGE'], 0, 2) ?>';
        </script>
